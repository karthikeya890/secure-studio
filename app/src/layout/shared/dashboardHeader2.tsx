...
const DashBoardHeader = () => {
    ...
    return (
        <Flex h={20} my={3}>
            <Flex boxShadow={"2xl"} bg={'white'} w={"100%"} px={12} mx={3} borderRadius={25} justifyContent={"space-between"} alignItems={"center"}>
                ...
                <Flex gap={4} alignItems={"center"}  >
                    ...
                    <Button borderRadius={25} variant={"solid"} onClick={logout} >Logout</Button>
                </Flex>
            </Flex>
        </Flex>
    )
